...
def setUp_inputs_QHJ(trainPath = None, valPath = None, testPath = None, rfModel=None):
    ...
    if trainPath:
        ...
        train = _setUp_inputs_QHJ_KS(trainPath, wordEmbedding, wordVocab, rfModel, 0, 15,1)
    ...
    if valPath:
        ...
        val = _setUp_inputs_QHJ_KS(valPath, wordEmbedding, wordVocab, rfModel, 0, 10, 3)
    ...
    if testPath:
        ...
        test = _setUp_inputs_QHJ_KS(testPath, wordEmbedding, wordVocab, rfModel, 0, 10, 2)
...
def setUp_inputs_QHJ_lawone(trainPath = None, valPath = None, testPath = None, rfModel=None,flag=0):
    ...
    if valPath:
        val = _setUp_inputs_QHJ_lawone(valPath, wordEmbedding, wordVocab, rfModel, 0, 10000, flag)

    if testPath:
        test = _setUp_inputs_QHJ_lawone(testPath, wordEmbedding, wordVocab, rfModel, 0, 10000, flag)
