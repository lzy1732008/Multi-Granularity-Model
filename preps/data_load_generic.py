...
def data_load(trainPath, valPath, testPath,model,rfModel,flag):
    ...
    # with open('resource/data_aug/jtzs_aug_with_whole.json','w',encoding='utf-8') as fw:
    #     dataset = {}
    ...
    # if flag == 0:
    #     with open('resource/data_aug/jtzs_aug_with_whole.json', 'r', encoding='utf-8') as fr:
