...
#
# fr1 = open('resource/预测结果分析/MultiGranularityCNN_predictAna.json','r',encoding='utf-8')
# fr2 = open('resource/预测结果分析/MGC_15predictAna.json','r',encoding='utf-8')
...
# with open('resource/预测结果分析/模型15预测错误-基于法条排序.txt','w',encoding='utf-8') as fw:
...
lines = open('resource/train-删除1.txt','r',encoding='utf-8').read().split('\n')
label_0 = []
count = 0
for line in lines:
    line = line.strip()
