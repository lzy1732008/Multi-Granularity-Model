...
class MultiGranularityCNNModel:
    ...
    def build_model(self):
        ...
        with tf.variable_scope("fusion-layer-1"):
            ...
            self.fusion_output_mean_1 = tf.reduce_mean(self.fusion_output_1,axis=-1)
        ...
        with tf.variable_scope("fusion-layer-2"):
            ...
            self.fusion_output_mean_2 = tf.reduce_mean(self.fusion_output_2, axis=-1)
        ...
        with tf.variable_scope("fusion-layer-3"):
            ...
            self.fusion_output_mean_3 = tf.reduce_mean(self.fusion_output_3, axis=-1)

        with tf.variable_scope("Augment-layer"):
            self.fusion_output = tf.concat([self.fusion_output_mean_1,self.fusion_output_max_1,
                                            self.fusion_output_mean_2,self.fusion_output_max_2,
                                            self.fusion_output_mean_3,self.fusion_output_max_3],
                                            axis=-1) #[B,2l]
