...
# 融入先验知识的方式是在进入CNN前加入encoder层，使用KEHNN的知识门方式融入知识
...
class MultiGranularityCNNModel:
    ...
    def build_model(self):
        ...
        with tf.variable_scope("first-CNN-layer"):
            ...
            self.output_x2_1 = tf.layers.conv1d(self.output_encoder,filters=self.config.filters_num,kernel_size=self.config.first_kernel_size,padding='same',name='first-cnn2')
