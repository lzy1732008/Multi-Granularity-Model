...
class MultiGranularityCNNModel:
    ...
    def build_model(self):
        ...
        with tf.variable_scope("zero-interaction-layer"):
            ...
            self.inter_0 = self.interaction2(self.input_X1,self.input_X2)
        ...
        with tf.variable_scope("first-interaction"):
            ...
            #=======================
            self.inter_1 = self.interaction2(self.output_x1_1, self.output_x2_1)
        ...
        with tf.variable_scope("second-interaction"):
            ...
            self.inter_2 = self.interaction2(self.output_x1_2,self.output_x2_2)
        ...
        with tf.variable_scope("third-interaction"):
            ...
            self.inter_3 = self.interaction2(self.output_x1_3,self.output_x2_3)
