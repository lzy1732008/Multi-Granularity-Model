...
class MultiGranularityCNNModel:
    ...
    def build_model(self):
        ...
        with tf.variable_scope("fusion-layer-3"):
            ...
            self.fusion_output_3 = tf.concat([self.input_X2, self.x2_inter_3,self.x2_label],axis=-1)
